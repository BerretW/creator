...
RegisterServerEvent("aprts_charCreator:Server:logCharacter")
AddEventHandler("aprts_charCreator:Server:logCharacter", function(Playerdata)
    if source then
        ...
        lib.logger(source, 'CharCreated', message)
    end
end)