...
local function CreateMenu()
    ...
    local subMenu = jo.menu.create('subMenu', {
        title = "Moje Koně",
        onEnter = function()
            dprint('enter subMenu')
        end,
        onBack = function()
            dprint('pressed BACK subMenu')
        end,
        onExit = function()
            dprint('exit subMenu')
        end
    ...
    local sellMenu = jo.menu.create('sellMenu', {
        title = "Prodej Koní",
        onEnter = function()
            dprint('enter sellMenu')
        end,
        onBack = function()
            dprint('pressed BACK sellMenu')
        end,
        onExit = function()
            dprint('exit sellMenu')
        end
    })
    ...
    for i, kun in ipairs(myHorses) do
        local price = math.floor(getHorsePrice(kun) / Config.Sell)
        sellMenu:addItem({
