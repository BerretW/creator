...
client_scripts {"@uiprompt/uiprompt.lua",'locale.lua', 'client/dataview.lua', 'client/cl_main.lua', 'client/client.lua', 'client/designer.lua','client/bags.lua',
                ...
                'client/npc.lua', 'client/shop.lua','client/menu.lua', 'client/prompt.lua','client/horsePromprs.lua','client/attributes.lua','keys.lua','client/components.lua'}
...
shared_scripts {'@jo_libs/init.lua', 'horses.lua', 'comp.lua','@ox_lib/init.lua' }
ui_page {"nui://jo_libs/nui/menu/index.html"}
jo_libs {'menu', 'notification','date',}
