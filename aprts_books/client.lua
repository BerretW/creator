...
RegisterNetEvent('books:openBookID')
AddEventHandler('books:openBookID', function(id)
    local pdfUrl = Books[id].pdf_url
...
exports('open_book', function(url)
    SetNuiFocus(true, true)
    SendNUIMessage({
        action = 'openBook',
        pdfUrl = url
