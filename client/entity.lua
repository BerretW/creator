...
local function mulNumber(vector1, value)
    local result = {}
...
local function s2w(camPos, relX, relY)
...
--             sellectingEntity = true
--             SetNuiFocus(true, true)
--         end
--         if sellectingEntity then
